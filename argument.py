...
def parse_args(args=None):
    ...
    p.add('--step_stddev', type=float, default=0.4, help='每行进一步时粒子的分散高斯分布的标准差，人均步长为0.8米')
    ...
    p.add('--decay_rate', type=float, default=0.0001, help='Rate of decaying the learning rate.')
